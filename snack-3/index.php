...
for ($i = 0; $i < count($posts); $i++) {
    ...
    $chiaveData = array_keys($posts)[$i];

    for ($z = 0; $z < count($posts[$chiaveData]); $z++) {
        echo '<b>' . $posts[$chiaveData][$z]['title'] .'</b>'  . '<br>';
        echo $posts[$chiaveData][$z]['author'] . '<br>';
        echo $posts[$chiaveData][$z]['text'] . '<hr>';
    }
}
